...
<Image alt="initial eslint CI run" src={import('./without-cache.png')} width="900" format="webp"/>

Subsequent runs will be much faster. This run took about 1s.
<Image alt="subsequent eslint CI run" src={import('./with-cache.png')} width="900" format="webp"/>
