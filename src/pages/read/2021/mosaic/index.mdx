...
<Image alt="Image Editor" src={import("./editor.png")} width={400} format="webp"/>
...
<Image alt="Content Feed" src={import("./feed.png")} width={400} format="webp"/>

**login**

<Image alt="Login" src={import("./login.png")} width={400} format="webp"/>

**post**

<Image alt="Post" src={import("./post.png")} width={400} format="webp"/>

**profile**

<Image alt="Profile" src={import("./profile.png")} width={400} format="webp"/>

**randomizer**

<Image alt="Randomizer" src={import("./random.png")} width={400} format="webp"/>
