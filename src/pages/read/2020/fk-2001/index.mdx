...
<Image alt="Focus FK-2001 (Asian 102 layout)" src={import("./fk-0.jpg")} format="webp" width="400" />
...
<Image alt="The Chain of Adapters" src={import("./fk-5.jpg")} format="webp" width="400" />
...
<Image alt="Out of the Case" src={import("./fk-1.jpg")} format="webp" width="400" />

**keycaps off**

<Image alt="Keycaps Off" src={import("./fk-2.jpg")} format="webp" width="400" />
...
<Image alt="Alps Keycaps" src={import("./fk-3.jpg")} format="webp" width="400" />

**alps switches**

<Image alt="Alps style switches" src={import("./fk-4.jpg")} format="webp" width="400" />
...
<Image alt="C, D, G, V labels on the pcb" src={import("./fk-6.jpg")} format="webp" width="400" />
...
<Image alt="The Setup" src={import("./fk-7.jpg")} format="webp" width="400" />
...
<Image alt="Pro-Micro in Place" src={import("./fk-8.jpg")} format="webp" width="400" />

**usb mini-b port**

<Image alt="USB Mini-B Port" src={import("./fk-9.jpg")} format="webp" width="400" />
...
<Image alt="Restored FK-2001" src={import("./fk-10.jpg")} format="webp" width="400" />
