...
<MdImage alt="Image Editor" src={import("./editor.png")} />
...
<MdImage alt="Content Feed" src={import("./feed.png")} />

**login**

<MdImage alt="Login" src={import("./login.png")} />

**post**

<MdImage alt="Post" src={import("./post.png")} />

**profile**

<MdImage alt="Profile" src={import("./profile.png")} />

**randomizer**

<MdImage alt="Randomizer" src={import("./random.png")} />
