...
- [github](https://github.com/ec965/kuw_dither)
...
In order to reduce network payload when serving images, they dither all their images
...
<MdImage
  src={import("./4chan_japanese_street.png")}
...
ImageMagick is program that can easily do a whole myraid of image transformations
...
You can find this script in the [GitHub repository](https://github.com/ec965/kuw_dither).
...
<MdImage
  src={import("./ocean_waves_original.jpg")}
...
<MdImage
  src={import("./ocean_waves_kuw_dither.jpg")}
