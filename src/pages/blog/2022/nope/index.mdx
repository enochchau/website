...
<MdImage src={import("./00_sf_towers.jpg")} alt="Sf Towers" />
...
<MdImage
  src={import("./01_north_beach_walking.jpg")}
...
<MdImage
  src={import("./02_above_walton_square.jpg")}
...
<MdImage src={import("./03_down_jackson.jpg")} alt="Down Jackson Street" />

I also passed by the parking garage I used to park at.
They have a good deal, it's $16 to park if you get in before 9AM.

<MdImage src={import("./04_my_parking_garage.jpg")} alt="My parking garage" />
...
So I've been taking Bart to work recently, which gives me a chance to go on these morning walks.
...
<MdImage
  src={import("./05_towards_blue_bottle.jpg")}
...
<MdImage src={import("./06_blue_bottle.jpg")} alt="Blue bottle inside" />

I got a single origin pour over coffee, made fresh by the barista Alejandro.
He recognized by name as being biblical since he grew up in a Church.
But like me, he doesn't go the church anymore.
He said his friend has been getting him into Free Masonry.
It seems to a secretive society as he couldn't really tell me what they do.
...
<MdImage src={import("./07_sculptures.jpg")} alt="sculptures" />

There's a wood sculpture installation at the office complex adjacent to Walton Square.
...
<MdImage
  src={import("./08_sales_force_building.jpg")}
...
<MdImage src={import("./11_sf_moma.jpg")} alt="SF Moma" />

Speaking of art, Yerba Beuna Park is right across the street form the SF MOMA.
The MOMA was free for minors so it wasn't uncommon for my high school friends to go there on a weekend for fun.
...
I like going out to drink, but mostly just for the conversation.
Words flow more freely with a little bit of alcoholic social lubrication.
What can I say, I'm a conversation enthusiast.

We stopped by Novelle but it was a bit too crowded so I suggest House of Shields.

<MdImage src={import("./12_novelle.jpg")} alt="Novelle" />

It was only a shy 400ft away.

<MdImage
  src={import("./13_sales_force_tower_night.jpg")}
  alt="Sales force tower at night"
/>

<MdImage src={import("./14_house_of_shields.jpg")} alt="House of Shields" />
...
<MdImage
  src={import("./15_house_of_shields_inside.jpg")}
...
<MdImage src={import("./16_drinks.jpg")} alt="Drinks" />
...
I like the boozy sweetness of drinks like the Old Fashioned and the Sazerac.

I'm been drinking more whiskey lately.
My Mom came through and got me a bottle of Kavalan Single Cask Whiskey at duty free before coming back from Taiwan.
Those bottles go for around [$250](https://www.totalwine.com/spirits/scotch/single-malt/kavalan-whisky-solist/p/151857750) for 750ml in the US but Mom got a 1L bottle for just $160.
