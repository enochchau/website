...
<MdImage
  src={import("./00_mels_chocolate_croissant.avif")}
...
<MdImage src={import("./01_mels_bread.avif")} alt="mel bread" />
...
<MdImage src={import("./02_walking_graph.avif")} alt="walking graph" />
...
<MdImage
  src={import("./03_whisky_tavern_thursday.avif")}
