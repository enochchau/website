...
_Noriega >> Irving >> Golden Gate Park >> Balboa >> Golden Gate Park >> Noriega_
...
<MdImage src={import("./00_sunset_walking.avif")} alt="sunset walking" />
...
<MdImage src={import("./01_irving.avif")} alt="Irving St" />

The Sunset district is kinda like San Francisco's second Chinatown.
Noriega is one part, Irving is another, Judah and Taraval round it out.
...
<MdImage src={import("./02_lunch.avif")} alt="Lunch" />
...
<MdImage src={import("./03_soup.avif")} alt="Soup" />
...
<MdImage src={import("./04_ggp.avif")} alt="Golden Gate Park" />
...
<MdImage src={import("./05_jfk.avif")} alt="JFK Dr" />

As a climber, I found the "No Climbing" sign amusing.

Onward, into Richmond, for more coffee. Never too much coffee.

<MdImage src={import("./06_library.avif")} alt="Balboa Library" />

<MdImage src={import("./07_books.avif")} alt="Library Books" />
...
<MdImage src={import("./09_coffee_bus.avif")} alt="Coffee Bus" />
...
<MdImage src={import("./10_magazine.avif")} alt="Japanese Coffee Magazine" />
...
<MdImage src={import("./11_bbq.avif")} alt="Cha Siu" />
