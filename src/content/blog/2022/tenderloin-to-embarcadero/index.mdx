...
<MdImage
  src={import("./00_arisicult_croissant.avif")}
...
<MdImage src={import("./01_tenderloin.avif")} alt="Tenderloin walking" />
...
<MdImage
  src={import("./02_church_looking.avif")}
...
<MdImage
  src={import("./03_old_building_towards_park.avif")}
...
<MdImage src={import("./04_huntington_park.avif")} alt="Huntington Park" />
...
<MdImage src={import("./05_leaving_park.avif")} alt="Leaving the park" />
...
<MdImage src={import("./06_china_town.avif")} alt="china town" />
...
<MdImage
  src={import("./07_triange_coffee_shop.avif")}
...
<MdImage
  src={import("./08_path_near_embarcadero.avif")}
  alt="Path near Embarcadero"
/>

I love finding little nuggets of greenery in the concrete jungle.

<MdImage src={import("./09_embarcadero.avif")} alt="Embarcadero" />
...
<MdImage src={import("./10_ferry_building.avif")} alt="ferry building" />
...
<MdImage src={import("./11_ferry_building.avif")} alt="ferry building" />

Of course, the beautiful Bay and Bay Bridge in the fading light.

<MdImage src={import("./13_bay_bridge.avif")} alt="bay bridge" />

Our interns are ending their internship next week so this was a nice day to drink and talk after work.

<MdImage src={import("./12_fort_point_brews.avif")} alt="Fort point brews" />

<MdImage src={import("./14_the_bird.avif")} alt="the bird with the interns" />
