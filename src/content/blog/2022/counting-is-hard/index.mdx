...
<MdImage src={import("./00_wasted_yarn.avif")} alt="wasted yarn" />
...
<MdImage src={import("./01_magic_circle.avif")} alt="Magic Circle" />
...
<MdImage src={import("./02_count_is_hard.avif")} alt="Counting is Hard" />

I got to the point where I needed stuffing so I had to pause for a day.

<MdImage
  src={import("./03_in_need_of_stuffing.avif")}
...
<MdImage src={import("./04_leaf.avif")} alt="Leaf" />
...
<MdImage src={import("./05_stuffed.avif")} alt="Stuffed" />
...
<MdImage
  src={import("./06_in_need_of_needle.avif")}
...
<MdImage src={import("./07_bound.avif")} alt="Tangerine bound in yarn" />
...
<MdImage src={import("./08_tangerine.avif")} alt="Tangerine" />
...
<MdImage src={import("./09_loved_hat.avif")} alt="Loved hat" />
