...
<MdImage src={import("./00_sf_towers.avif")} alt="Sf Towers" />
...
<MdImage
  src={import("./01_north_beach_walking.avif")}
...
<MdImage
  src={import("./02_above_walton_square.avif")}
...
<MdImage src={import("./03_down_jackson.avif")} alt="Down Jackson Street" />

I also passed by the parking garage I used to park at.
They have a good deal, it's $16 to park if you get in before 9AM.

<MdImage src={import("./04_my_parking_garage.avif")} alt="My parking garage" />
...
<MdImage
  src={import("./05_towards_blue_bottle.avif")}
...
<MdImage src={import("./06_blue_bottle.avif")} alt="Blue bottle inside" />
...
<MdImage src={import("./07_sculptures.avif")} alt="sculptures" />
...
<MdImage
  src={import("./08_sales_force_building.avif")}
...
<MdImage src={import("./11_sf_moma.avif")} alt="SF Moma" />
...
<MdImage src={import("./12_novelle.avif")} alt="Novelle" />

It was only a shy 400ft away.

<MdImage
  src={import("./13_sales_force_tower_night.avif")}
  alt="Sales force tower at night"
/>

<MdImage src={import("./14_house_of_shields.avif")} alt="House of Shields" />
...
<MdImage
  src={import("./15_house_of_shields_inside.avif")}
...
<MdImage src={import("./16_drinks.avif")} alt="Drinks" />
