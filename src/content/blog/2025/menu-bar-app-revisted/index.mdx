...
<button style="width:80px;height:30px;background:#2563eb;color:white;border-radius:8px;font-weight:bold;">
  Buy
</button>
...
which I [then
implemented](https://github.com/enochchau/BrowserDefaults/commit/f3e1a6dfcfdbd3a2b55d4584a34ca3d1a5be7f54)
