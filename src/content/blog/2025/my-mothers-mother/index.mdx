...
<MdImage
  src={import("./me-and-grandma-at-carrefour.avif")}
...
<MdImage src={import("./grandma-wedding.avif")} alt="grandma's wedding photo" />
...
<MdImage src={import("./old-house-with-mom.avif")} alt="inside the old house" />
