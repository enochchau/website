...
After visiting Seattle in July, I noticed that many of my college friends working in big tech,
had bought or were buying homes.
...
probably something to do with the improving economic situation in the tech and VC sectors.
...
First, I emailed back every recruiter that had emailed me in the months of June and July
to setup initial calls.
...
I may have learned more about system design from YouTube shorts than I did from working as a software engineer up to this point in my career.
...
- The spiral follows this pattern:
    ...
    - Draw a line segment o length n-2
...
The backend code uses the asynchronous job queue library to run
the LLM calls in a non-blocking way. has some advantages but it
is not the best-maintained library and our team wishes to move to a
more mainstream tool, .
arq
arq
celery
...
with respect to constraints on LC problems where as in a real world problem, I would have been much more thorough.
Overall, most of the interviews seemed to take into account that candidates could use
AI to cheat on LC style questions.

For second round interviews, each company upped the anti with harder LC questions, system design,
and live coding.
...
My only reprieve was the climbing gym where I could isolate from my work life and hang out with my friends.
...
I've also realized that my original goal of income maxing for home ownership was kinda pointless
...
He would say "Hi" to all his coworkers as we walked through the halls.
We ended the tour on the rooftop overlooking Bellevue, he remarked that he'd been working there for more than ten years and that he really loved his job.
