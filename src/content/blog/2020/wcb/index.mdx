...
<MdImage alt="Main and Interface PCB" src={import("./pcb.avif")} />

**watercooler**

<MdImage alt="Watercooler" src={import("./outside.avif")} />

**demo user interface**

<MdImage alt="Demo User Interface" src={import("./front.avif")} />
